...
ActiveRecord::Schema.define(version: 20160822071537) do
  ...
  add_index "reviews", ["staff_id"], name: "index_reviews_on_staff_id"
  ...
  create_table "staffs", force: :cascade do |t|
    ...
    t.datetime "updated_at",             null: false
    t.integer  "user_id"
    t.string   "staff_img_file_name"
    t.string   "staff_img_content_type"
    t.integer  "staff_img_file_size"
    t.datetime "staff_img_updated_at"
  end
